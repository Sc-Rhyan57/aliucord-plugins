        ...
        patcher.patch(
            ...
            Hook { callFrame ->
                try {
                    ...
                    if (layout.findViewWithTag<View>("rethemer_injected") != null) {
                        log.info("REthemer: already injected, skipping")
                        return@Hook
                    }
                    ...
                    log.info("REthemer: qr_scanner found=${qrView != null} baseIndex=$baseIndex childCount=${layout.childCount}")

                    val insertAt = if (baseIndex >= 0) baseIndex + 1 else layout.childCount

                    // Invisible guard tag view
                    ...
                    log.info("REthemer: injected at $insertAt (childCount now=${layout.childCount})")
                } catch (e: Throwable) {
